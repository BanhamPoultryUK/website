...
CookieComplianceBanner.innerHTML = '<p>We use cookies on this site. You can find more information about cookies in our <a href="/cookie-policy">Cookie Policy</a>. <a class="close-cookie-banner" href="javascript:void(0);" onclick="removeMe();"><span>X</span></a></p>';
